...
const allArenas = [
  ...
  // ── LAHORE (4 new) ──────────────────────────────────────────────────────────
  {
    ...
    indoor: true,
    surface: 'Glass',
    facilities: ['Parking', 'Locker Rooms', 'Coaching', 'Cafe', 'Showers'],
  },
  {
    ...
    indoor: true,
    surface: 'Artificial Grass',
    facilities: ['Parking', 'Locker Rooms', 'Coaching'],
  },
  {
    name: 'Cantt Padel Zone',
    location: 'Lahore',
    courtType: 'Outdoor Court',
    price: 'Rs. 1,800',
    priceNum: 1800,
  ...
  },
  {
    ...
    indoor: true,
    surface: 'Glass',
    facilities: ['Parking', 'Cafe', 'Coaching', 'First Aid'],
  },
  ...
  // ── KARACHI (4 new) ─────────────────────────────────────────────────────────
  {
    ...
    indoor: true,
    surface: 'Glass',
    facilities: ['Parking', 'Locker Rooms', 'Coaching', 'Cafe', 'Gym'],
  },
  {
    name: 'Defence Padel Arena',
    location: 'Karachi',
    courtType: 'Premium Indoor Court',
    price: 'Rs. 2,700',
    priceNum: 2700,
    ...
    indoor: true,
    surface: 'Artificial Grass',
    facilities: ['Parking', 'Locker Rooms', 'Showers'],
  },
  {
    name: 'Gulshan Padel Zone',
    location: 'Karachi',
    courtType: 'Outdoor Court',
    price: 'Rs. 1,600',
    priceNum: 1600,
    ...
    indoor: false,
    surface: 'Concrete',
    facilities: ['Parking', 'First Aid'],
  },
  {
    name: 'Bahria Padel Courts',
    location: 'Karachi',
    courtType: 'Standard Court',
    price: 'Rs. 2,300',
    priceNum: 2300,
    ...
    indoor: true,
    surface: 'Synthetic',
    facilities: ['Parking', 'Equipment Rental', 'Coaching'],
  },

  // ── ISLAMABAD (4 new) ───────────────────────────────────────────────────────
  {
    name: 'F-10 Padel Club',
    location: 'Islamabad',
    courtType: 'Professional Glass Court',
    price: 'Rs. 2,800',
    priceNum: 2800,
  ...
  },
  {
    ...
    indoor: true,
    surface: 'Artificial Grass',
    facilities: ['Parking', 'Showers', 'First Aid'],
  },
  {
    name: 'G-11 Padel Arena',
    location: 'Islamabad',
    courtType: 'Outdoor Court',
    price: 'Rs. 2,000',
    priceNum: 2000,
  ...
  },
  {
    ...
    indoor: true,
    surface: 'Glass',
    facilities: ['Parking', 'Locker Rooms', 'Cafe', 'Coaching'],
  },

  // ── RAWALPINDI (4 new) ──────────────────────────────────────────────────────
  {
    name: 'Saddar Padel Hub',
    location: 'Rawalpindi',
    courtType: 'Premium Indoor Court',
    price: 'Rs. 1,900',
    priceNum: 1900,
  ...
  },
  {
    ...
    indoor: true,
    surface: 'Synthetic',
    facilities: ['Parking', 'Equipment Rental', 'First Aid'],
  },
  {
    name: 'Westridge Padel Club',
    location: 'Rawalpindi',
    courtType: 'Professional Glass Court',
    price: 'Rs. 2,300',
    priceNum: 2300,
  ...
  },
  {
    ...
    indoor: true,
    surface: 'Artificial Grass',
    facilities: ['Parking', 'Coaching', 'Showers'],
  },
];
